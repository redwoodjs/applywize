...
import { Breadcrumb, BreadcrumbList, BreadcrumbItem, BreadcrumbLink, BreadcrumbSeparator, BreadcrumbPage } from "@/app/components/ui/breadcrumb"
    ...
    <InteriorLayout>
      ...
      <div className="px-page-side">
        <header className="flex justify-between border-b-1 border-border pb-6 mb-12">
          ...
          <div>
            <Button><a href={application?.postingUrl as string} target="_blank" className="flex items-center gap-2">View Application <Icon id="external-link" size={16} /></a></Button>
          </div>
        </header>
